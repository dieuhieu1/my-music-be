  ...
  return (
    <main style={{ background: 'var(--charcoal)', minHeight: '100vh', overflowX: 'hidden', cursor: 'none' }}>
      ...
      <header style={{
        ...
        background: headerBg ? 'rgba(6,5,3,0.88)' : 'transparent',
        backdropFilter: headerBg ? 'blur(28px) saturate(180%)' : 'none',
        borderBottom: headerBg ? '1px solid rgba(232,184,75,0.1)' : 'none',
        ...
        <Link href={`/${locale}`} style={{ display: 'flex', alignItems: 'center', gap: 10, textDecoration: 'none' }}>
          <div style={{
            ...
            display: 'flex', alignItems: 'center', justifyContent: 'center',
            boxShadow: '0 0 24px rgba(232,184,75,0.45)',
          ...
          <span style={{ fontFamily: 'var(--font-display)', fontSize: '1.18rem', fontWeight: 600, color: 'var(--ivory)', letterSpacing: '0.01em' }}>
            My Music
          </span>
        </Link>
